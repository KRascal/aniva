...
export function detectEmotionForDelay(text: string): { emotion: TextEmotion; delay: number; pauseEffect: boolean } {
...
export const LOVE_WORDS = /好き|愛して|愛してる|大好き|最高|嬉しい|ありがとう|love|suki/i;

// LLM APIで動的にリアクション応答を取得
export async function fetchReactionResponse(characterId: string, emoji: string, lastMessage?: string): Promise<string> {
  try {
