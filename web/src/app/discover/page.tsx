    ...
    <div className="fixed inset-0 bg-gray-950 z-50 overflow-hidden select-none">
      ...
      <div className="absolute bottom-14 left-0 right-0 z-30 flex items-center justify-center gap-8 px-6 pb-4">
        ...
        <button
          ...
          disabled={isAnimating}
          className="w-[68px] h-[68px] rounded-full bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center shadow-xl shadow-green-900/40 active:scale-90 transition-transform border-2 border-white/20"
        >
