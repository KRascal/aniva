...
import GachaBannerForm, {
  ANIMATION_TYPES,
  type BannerFormState,
} from '@/components/admin/GachaBannerForm';
import GachaCardForm, {
  FRAME_TYPES,
  type CardFormState,
...
const BANNER_EMPTY: BannerFormState = {
  name: '',
  description: '',
  characterId: '',
  startAt: '',
...
const CARD_EMPTY: CardFormState = {
  name: '',
  description: '',
  characterId: '',
  rarity: 'R',
...
export default function AdminGachaPage() {
  ...
  const [bannerForm, setBannerForm] = useState<BannerFormState>(BANNER_EMPTY);
        ...
        <div>
          ...
          {showBannerForm && (
            <GachaBannerForm
              ...
              preRollJsonError={preRollJsonError}
              setPreRollJsonError={setPreRollJsonError}
              saving={saving}
              onSubmit={createBanner}
              onCancel={() => { setShowBannerForm(false); setError(''); setPreRollJsonError(''); }}
            />
          )}
        ...
        <div>
          ...
          {showCardForm && (
            <GachaCardForm
              ...
              saving={saving}
              onSubmit={createCard}
              onCancel={() => { setShowCardForm(false); setError(''); }}
            />
          )}
