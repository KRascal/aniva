...
import { Character, RelationshipInfo } from '@/components/explore/types';
import { FRANCHISE_CATEGORIES } from '@/components/explore/constants';
        ...
        <main className="relative z-10 max-w-lg mx-auto px-4">
          ...
          {!searchQuery && selectedCategory === 'すべて' && (
            <div className="py-6">
              {/* Hero banner */}
              <FadeSection>
                <ExploreHeroBanner characters={characters} />
              </FadeSection>
