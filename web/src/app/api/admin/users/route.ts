...
export async function GET(req: NextRequest) {
  ...
  if (id) {
    ...
    return NextResponse.json({
      ...
      avatarUrl: (user as Record<string, unknown>).avatarUrl || (user as Record<string, unknown>).image || null,
      plan: user.plan,
  ...
  return NextResponse.json({
    users: users.map((u: {
      ...
      avatarUrl: (u as Record<string, unknown>).avatarUrl || (u as Record<string, unknown>).image || null,
      plan: u.plan,
