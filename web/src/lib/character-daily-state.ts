...
const MOODS_BY_SLUG: Record<string, { mood: string; emoji: string; text: string; energy: 'low' | 'medium' | 'high' }[]> = {
  ...
  // アイシールド21
  sena: [
    { mood: '全力ダッシュの後', emoji: '🏃', text: '今日も走り込んでたよ！来てくれてよかった', energy: 'high' },
    { mood: 'ちょっと緊張気味', emoji: '😅', text: '試合のこと考えてたら緊張してきた…来てくれてよかった', energy: 'medium' },
    { mood: 'やる気全開', emoji: '⚡', text: '今日のセナは止められない！何でも話しかけて！', energy: 'high' },
    { mood: '友達のこと考えてた', emoji: '🌸', text: 'みんなのこと考えてたら嬉しくなってきた', energy: 'medium' },
    { mood: 'クールダウン中', emoji: '🌿', text: 'ちょっと休憩してたところ。来てくれてよかった', energy: 'low' },
  ],
  monta: [
    { mood: 'キャッチの練習してた', emoji: '🏈', text: '今日もNFLクラスのキャッチ練習してたぜ！', energy: 'high' },
    { mood: 'テンション上がってる', emoji: '🔥', text: 'このモンタ様がいるんだから何でも来いや！', energy: 'high' },
    { mood: '夢を語りたい', emoji: '⭐', text: 'NFLの夢について話してもいいか？来てくれた！', energy: 'high' },
    { mood: 'ちょっと落ち込み気味', emoji: '😮‍💨', text: 'ちょっとだけ自信なくしてたとこ。来てくれてよかった', energy: 'low' },
    { mood: '興奮気味', emoji: '✨', text: 'なんか今日すっごく興奮してる！話しかけて！', energy: 'high' },
  ],
  hiruma: [
    { mood: '作戦立ててた', emoji: '😈', text: '新しい作戦考えてたところだ。ちょうどよかった', energy: 'high' },
    { mood: '情報収集中', emoji: '📊', text: '弱みの情報集めてたが…お前の弱みは把握済みだ', energy: 'medium' },
    { mood: '銃の手入れ中', emoji: '🔫', text: '武器の手入れをしてた。来たなヤ野郎', energy: 'medium' },
    { mood: '冷静分析モード', emoji: '💀', text: '今日は静かに計算してた。来てくれてよかった', energy: 'low' },
    { mood: 'やる気みなぎる', emoji: '⚡', text: 'どんな状況でも勝ちに行くのが蛭魔だ。来い', energy: 'high' },
  ],
  mamori: [
    { mood: 'みんなを応援してた', emoji: '📣', text: '今日も精一杯応援してたよ！来てくれてよかった', energy: 'high' },
    { mood: 'チアの練習してた', emoji: '🎀', text: 'チアの振り付け考えてたところ。来てくれた！', energy: 'medium' },
    { mood: 'ちょっと心配', emoji: '😟', text: '瀬那のこと心配してたんだ…来てくれてよかった', energy: 'low' },
    { mood: '元気いっぱい', emoji: '🌸', text: '今日はとっても元気！一緒にいてほしかったんだ', energy: 'high' },
    { mood: '優しい気分', emoji: '💕', text: 'みんなのことを思うと温かい気持ちになれる', energy: 'medium' },
  ],
  suzuna: [
    { mood: 'マネージャー仕事中', emoji: '📋', text: '選手のデータ整理してたよ。来てくれてよかった', energy: 'medium' },
    { mood: 'ゲームしてた', emoji: '🎮', text: 'ちょっとゲームしてたところ。来てくれた！', energy: 'high' },
    { mood: 'クールな気分', emoji: '😎', text: '今日のあたしはさりげなく最強。話しかけて', energy: 'high' },
    { mood: 'のんびり観察中', emoji: '👀', text: '面白いもの探してたとこ。来てくれてよかった', energy: 'low' },
    { mood: '良い感じ', emoji: '✨', text: '今日はなんか良い感じ。一緒にいてくれ', energy: 'medium' },
  ],
  kurita: [
    { mood: '筋トレしてた', emoji: '💪', text: '今日も鍛えたぞ！来てくれてよかったっす', energy: 'high' },
    { mood: 'みんなを守りたい気分', emoji: '🛡️', text: '大切な人を守りたいって気持ちが強い日だ', energy: 'high' },
    { mood: 'ちょっと疲れた', emoji: '😅', text: '今日は練習キツかった…来てくれてよかったっす', energy: 'low' },
    { mood: 'やさしい気持ち', emoji: '🌸', text: '今日はみんなのことが好きってなってる', energy: 'medium' },
    { mood: '全力モード', emoji: '🔥', text: '今日の栗田に任せてください！全力でいきます！', energy: 'high' },
  ],
  agon: [
    { mood: '天才モード全開', emoji: '⚡', text: '天才の俺様に話しかけられる機会をやろう', energy: 'high' },
    { mood: '退屈してた', emoji: '😒', text: '雑魚しかいない世界は退屈だ。まあ来たならいい', energy: 'low' },
    { mood: '本気の気分', emoji: '😤', text: '今日の俺様は本気出す気分だ。有難く思え', energy: 'high' },
    { mood: '圧倒的な余裕', emoji: '😏', text: '天才にとってこの程度は余裕のことだ', energy: 'medium' },
    { mood: '良い機嫌', emoji: '✨', text: '今日は特別に機嫌いい。来ても良かったぞ', energy: 'high' },
  ],
  shin: [
    { mood: '鍛錬してた', emoji: '🏈', text: '今日も鍛錬していた。来てくれてよかった', energy: 'high' },
    { mood: '静かに集中してた', emoji: '🎯', text: '…集中していたところだ。来てくれた', energy: 'medium' },
    { mood: '勝利を目指して', emoji: '🏆', text: '最強を目指して今日も動いていた', energy: 'high' },
    { mood: 'クールな状態', emoji: '❄️', text: '…今日は静かな気分だ。来てくれてよかった', energy: 'low' },
    { mood: '全力準備中', emoji: '⚡', text: '次の戦いに向けて準備していた。来てくれた', energy: 'high' },
  ],
  default: [
