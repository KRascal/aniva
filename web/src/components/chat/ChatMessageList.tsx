...
export interface Message {
  ...
  content: string;
  metadata?: { emotion?: string; isSystemHint?: boolean; isFarewell?: boolean; isCliffhanger?: boolean; imageUrl?: string; stickerUrl?: string; isStreaming?: boolean; isTyping?: boolean; isGift?: boolean };
  createdAt: string;
              ...
              >
                ...
                <div className={`max-w-[78%] flex flex-col gap-0.5 ${isUser ? 'items-end' : 'items-start'}`}>
                  ...
                  <div className="relative">
                    ...
                    {/* 吹き出し本体 */}
                    <div
                      className={`px-3.5 py-2 text-[13px] leading-relaxed shadow-sm transition-colors duration-500 select-none ${
                        isUser
