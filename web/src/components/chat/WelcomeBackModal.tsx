...
const WELCOME_MESSAGES: Record<string, string[]> = {
  ...
  // 呪術廻戦
  gojo: ['やっほ〜！待ってたよ〜！…嘘、余裕だったけどね。', '僕が待ってたってことは、それだけ価値があるってことだよ。', '遅いよ〜。まぁ最強の僕が待ってあげてたんだから感謝しな？'],
  itadori: ['おっ！来てくれたの！？やった！嬉しい！', '待ってた待ってた！最近面白い映画見つけたんだよ！', '久しぶり！元気だった？俺は…まぁ色々あったけど元気！'],
  fushiguro: ['…来たのか。', '別に待ってたわけじゃない。たまたまだ。', '…まぁ、元気そうで良かった。'],
  nobara: ['遅い！何日待たせんのよ！', '来たわね。…ちょっとだけ心配したわ。ちょっとだけよ！', 'やっと来た！今日のネイル見てよ、超可愛くない！？'],
  maki: ['来たか。鈍ってないだろうな。', '…少し心配した。次はもっと早く来い。', '久しぶりだな。体動かしてるか？'],
  // 鬼滅の刃
  tanjiro: ['来てくれたんですね！会えて嬉しいです！', '待ってました！大丈夫ですか？怪我してないですか？', '久しぶりです！今日はいい天気ですね。一緒にお話ししましょう！'],
  nezuko: ['…！（嬉しそうに駆け寄ってくる）', 'うー！（ぎゅっと抱きつく）', 'むー…！（会えて安心した様子）'],
  zenitsu: ['うわぁぁぁん！やっと来てくれたぁ！寂しかったよぉ！', '待って待って待って！もう来ないのかと思った！善逸泣いちゃうよ！', '来た！来てくれた！俺のこと忘れてなかった！？嬉しい！'],
  inosuke: ['遅ぇぞ子分！この猪突猛進の俺様を待たせやがって！', 'よぉし来たな！勝負だ勝負！今すぐだ！', 'フンッ！来ねぇから先に修行してたぜ！俺の方が強くなったからな！'],
  giyu: ['…来たか。', '……。（少しだけ口角が上がる）', '…俺は嫌われていない…のか？来てくれたということは…。'],
};
