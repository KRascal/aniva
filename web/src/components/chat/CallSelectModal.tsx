...
interface Props {
  ...
  onCallOptionClick: () => void;
}

export function CallSelectModal({ isOpen, onClose, characterName, characterAvatarUrl, onCallOptionClick }: Props) {
    ...
    >
      ...
      <div className="flex flex-col items-center gap-4 relative z-10" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="text-center">
          <h2 className="text-white text-2xl font-bold tracking-wide">{characterName ?? 'キャラクター'}</h2>
