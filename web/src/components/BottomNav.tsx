...
export function BottomNav() {
  ...
  return (
    <>
      <nav
        className="fixed bottom-0 left-0 right-0 z-50 bg-gray-900/95 backdrop-blur-xl border-t border-white/8"
      ...
      >
        <div className="flex justify-around items-stretch h-16">
          ...
          >
            ...
            <span className={`text-[10px] font-semibold ${isHome ? 'text-purple-400' : 'text-gray-500'}`}>さがす</span>
          </Link>
          ...
          >
            ...
            <span className={`text-[10px] font-semibold ${isTimeline ? 'text-purple-400' : 'text-gray-500'}`}>タイムライン</span>
          </Link>

          {/* チャット - center, prominent */}
          <Link
            href="/chat"
            className="flex flex-col items-center justify-center gap-1 flex-1 min-h-[44px] transition-all rounded-xl mx-1"
          >
            ...
            <span className={`text-[10px] font-semibold ${isChat ? 'text-purple-400' : 'text-gray-400'}`}>チャット</span>
          </Link>
          ...
          >
            ...
            <span className={`text-[10px] font-semibold ${isMypage ? 'text-purple-400' : 'text-gray-500'}`}>マイページ</span>
          </Link>
        </div>
      </nav>
      {/* Safe-area-aware spacer */}
