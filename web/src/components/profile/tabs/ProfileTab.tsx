...
import { SparkStar, PersonalityTraitsSection } from '../ProfileComponents';
import { CHARACTER_PROFILES, CREW_MEMBERS, PROFILE_LABELS, PRESET_INTERESTS, type CharacterProfile } from '../profileData';
import type {
  Character,
  RelationshipData,
  MilestonesData,
...
interface ProfileTabProps {
  ...
  saveLoading: boolean;
  saveSuccess: boolean;
  onSaveCustomization: () => Promise<void>;
