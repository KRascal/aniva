...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="flex items-center gap-1.5 px-2.5 py-1.5 rounded-full bg-[var(--color-surface-2)] hover:bg-[var(--color-border)] text-[var(--color-text)] transition-all duration-200"
      aria-label="テーマ切り替え"
