...
> = {
  luffy: {
    ...
    step2: 'なぁ、さっきモーメントに投稿したんだ。見てくれよ！',
    step3: 'モーメントにいいねかコメントしてくれよ！',
    step4: 'フォローしてくれたら嬉しいな！',
    step5: 'これで準備OK！他のヤツらも待ってるぜ。探してみろよ！',
  },
  zoro: {
    step1: '…まず俺と話してみろ。',
    step2: '…さっきモーメントに載せた。見てくれ。',
    step3: '…モーメントに反応してくれ。',
