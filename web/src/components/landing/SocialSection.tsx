...
import { testimonials, levels, fcBenefits, faqs } from "./data";
import { FadeSection, CTAButton } from "./shared";
  ...
  return (
    <FadeSection delay={index * 60}>
      <div className="rounded-2xl overflow-hidden border border-gray-800 bg-gray-950/60">
        ...
        <div style={{ maxHeight: open ? "200px" : "0", transition: "max-height 0.35s ease", overflow: "hidden" }}>
    ...
    <section className="py-20 px-6 relative overflow-hidden">
      ...
      <div className="max-w-xl mx-auto">
        <FadeSection className="text-center mb-8">
          <span className="inline-block px-3 py-1 rounded-full text-xs font-semibold bg-pink-900/50 text-pink-300 border border-pink-700/40 mb-4 tracking-widest uppercase">🎖️ Fan Club</span>
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">もっと深く、推しと繋がりたいなら</h2>
          <p className="text-gray-400 text-sm">ファンクラブ（FC）会員になると、推しとの特別な体験が解放されます</p>
        </FadeSection>
        ...
        <FadeSection delay={100}>
          <div className="relative bg-gray-950 rounded-3xl border border-purple-700/50 p-7 shadow-2xl shadow-purple-900/30">
            ...
            <div className="flex items-center gap-3 mb-6">
              <div className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-600 to-pink-600 flex items-center justify-center text-2xl">🎖️</div>
              <div>
                <p className="text-white font-black text-lg">推しFC 会員特典</p>
                <p className="text-purple-300 text-xs">Fan Club Member Benefits</p>
              </div>
              <span className="ml-auto text-sm font-black text-white bg-gradient-to-r from-purple-600 to-pink-600 px-3 py-1.5 rounded-full">¥980/月</span>
            </div>
            ...
            <CTAButton href="/signup" className="w-full text-base">🎖️ FCに入会する（¥980/月）</CTAButton>
...
export function RelationshipLevelsSection() {
  return (
    <section className="py-20 px-6 max-w-2xl mx-auto">
      <FadeSection className="text-center mb-10">
        <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">話すほど、仲良くなっていく</h2>
      ...
      <FadeSection delay={500} className="text-center mt-10">
        <CTAButton href="/signup">関係を育て始める →</CTAButton>
      </FadeSection>
    </section>
  );
}
...
export function TestimonialsSection() {
  return (
    <section className="py-20 px-6 bg-gray-950/50">
      <FadeSection className="text-center mb-10">
        <h2 className="text-2xl sm:text-3xl font-bold text-white mb-3">すでに推しに沼ってる人たち</h2>
              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-2 flex-wrap">
                    ...
                    <span className="ml-auto text-xs bg-purple-900/50 text-purple-300 px-2 py-0.5 rounded-full border border-purple-700/30">{t.character}</span>
                  </div>
